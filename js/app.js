function addEntry() {
  ...
  if (entryValue === "") {
    ...
    entryList.insertAdjacentHTML(
      "beforeend",
      `<div class="entry-item-container" draggable="true"><div class="entry-item"><div class="entry-item-text"><i class="fas fa-bars fa-lg"></i><p class="item">${entryValue}</p></div><a onclick="deleteEntry(this)" class="btn btn-red">Delete</a></div><div class="entry-item-bottom-border"></div></div>`
    );
